...
const { Product, Brand, Model, Category, SubCategory, Photo, User, Inquiry, Product2 } = require("../../models/allModels");
...
async function Upload(fastify, options) {
    ...
    fastify.post('/product2',  { onRequest: [fastify.authenticate] }, async function (req, reply) {
        try {
...
const newSmartwatch = new Product2({
    ...
    variants: [
      // Define variants for smartwatches
      {
        ...
        images: ['http://myserver.com/images/black_watch_1', 'http://myserver.com/images/black_watch_2'],
        SKU: "12345",
        price: 299.99
      },
  ...
  const newEarphones = new Product2({
    ...
    variants: [
      // Define variants for earphones
      {
        ...
        style: 'In-ear',
        connectivity: 'Bluetooth',
        images: ['http://myserver.com/images/white_earphones_1', 'http://myserver.com/images/white_earphones_2'],
        SKU: "67890",
        price: 99.99
      },
      // Include other variants as needed
